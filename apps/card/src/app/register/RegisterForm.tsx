...
export function RegisterForm({ settings, cardSettings = {} }: RegisterFormProps) {
    ...
    const form = useForm<any>({
        ...
        defaultValues: {
            ...
            mayorExtra: { position: '', visionTitle: '', visionSubtitle: '', greetingTitle: '', greetingText: '', heroImageUrl: '', declarationTitle: '', declarationVideoUrl: '', declarationText: '', heroImageScale: '', heroImageOffsetX: '', heroImageOffsetY: '' },
            mayorStories: [] as any[],
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert(settings.register_success || '성공적으로 저장되었습니다!');
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit, (errors) => {
                            ...
                            <div className="space-y-6 border-t pt-6">
                                ...
                                <div className="space-y-6 border-t pt-6 border-b pb-6">
                                    <DynamicList
                                        label={settings.register_section_careers || "🔥 주요 경력 (최신순)"}
                                ...
                                <div className="bg-yellow-50 p-4 rounded-xl space-y-4">
                                    <h3 className="font-bold text-gray-900 flex items-center gap-2">{settings.register_section_donation || '💰 후원 정보'}</h3>
                                ...
                                <div className="space-y-4">
                                    <h3 className="font-bold text-gray-900">{settings.register_section_social || '🔗 소셜 미디어'}</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-4 border-t pt-6">
                                    <h3 className="font-bold text-gray-900">{settings.register_section_contact || '📞 추가 정보'}</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <FormInput
                                            label="공개 연락처 (선택)"
                                ...
                                >
                                    {submitting ? <Loader2 className="animate-spin" /> : (settings.register_submit || '저장하기')}
                                </button>
                            </div>
                        </form>
                    )}
                ...
                {isFormStep && (
                    <div className="hidden lg:block lg:w-1/2 lg:h-screen lg:overflow-y-auto bg-gray-100 border-l border-gray-200">
                        ...
                        <div className="preview-scope">
                            <CandidatePreview data={watched} cardSettings={cardSettings} />
                        </div>
                    </div>
                )}
            </div>
