...
export function HeroSection({ candidate, settings }: HeroSectionProps) {
    return (
        <section className="relative min-h-fit flex items-center justify-center overflow-hidden bg-justice-yellow pt-20">
            ...
            <div className="max-w-7xl w-full mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
                <div className="text-black space-y-6 animate-in slide-in-from-bottom-10 duration-700 fade-in">
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold leading-tight tracking-tight">
                        ...
                        <span className="block mt-2">
                            ...
                            <span className="block text-2xl sm:text-3xl md:text-5xl font-bold whitespace-nowrap tracking-tighter mt-1 text-black drop-shadow-sm">
                                {candidate.mayorExtra?.position || `정의당 ${candidate.name}`}
                            </span>
                        </span>
                    </h1>

                    <p className="hero_txt text-xl md:text-2xl text-black font-medium leading-relaxed max-w-lg">
