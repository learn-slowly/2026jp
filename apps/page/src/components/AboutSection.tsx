...
export function AboutSection({ candidate, settings }: AboutSectionProps) {
    return (
        <section id="about" className="py-16 md:py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
                    <div className="space-y-8">
                        <h2 className="text-gray-900 font-bold text-lg tracking-wider uppercase">{settings.section_about_subtitle || '당신의 곁에 정의당이 있습니다'}</h2>
                    ...
                    <div className="bg-gray-50 rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
                        <h4 className="text-2xl font-bold text-gray-900 mb-8 border-b pb-4">{settings.section_careers || '주요 경력'}</h4>
